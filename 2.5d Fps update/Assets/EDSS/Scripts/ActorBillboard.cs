    ...
    public class ActorBillboard : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (actorTransform != null)
            {
                ...
                actorForwardVector = actorTransform.right;
            }
            ...
            if (cameraVector.sqrMagnitude > Mathf.Epsilon)
            {
                ...
                if (currentAnimation != null && spriteRenderer != null)
                {
                    ...
                    if (currentAnimation.AnimType == ActorAnimation.AnimDirType.EightDirections)
                    {
                        ...
                        float viewAngle = -Vector3.SignedAngle(cameraVector, actorForwardVector, Vector3.back);
                ...
                Quaternion billboardRotation = Quaternion.LookRotation(cameraVector, Vector3.back);
