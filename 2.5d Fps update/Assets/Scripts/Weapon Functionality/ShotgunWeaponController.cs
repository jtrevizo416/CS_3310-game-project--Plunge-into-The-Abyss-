...
public class ShotgunWeaponController : MonoBehaviour
{
    ...
    public static ShotgunWeaponController instance;
    ...
    private void Update()
    {
        //WeaponDamage();
        DeathCheck();
        if (!hasDied && pauseMenu.getPauseState() == false)
        {
    ...
    private void Shoot()
    {
        ...
        if (currentAmmo > 0)
        {
            ...
            currentAmmo--;
            AudioController.instance.PlayShotgunShot();//play gunshot sound when player shoots
